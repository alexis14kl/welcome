...
`;var $o=["*"],jo={root:"p-fluid"},Qn=(()=>{class e extends F{name="fluid";classes=jo;theme=Gn;static \u0275fac=(()=>{let t;return function(i){return(t||(t=w(e)))(i||e)}})();static \u0275prov=H({token:e,factory:e.\u0275fac})}return e})();var Jn=(()=>{class e extends V{_componentStyle=x(Qn);static \u0275fac=(()=>{let t;return function(i){return(t||(t=w(e)))(i||e)}})();static \u0275cmp=T({type:e,selectors:[["p-fluid"]],hostVars:2,hostBindings:function(n,i){n&2&&v(i.cx("root"))},features:[R([Qn]),L],ngContentSelectors:$o,decls:1,vars:0,template:function(n,i){n&1&&(ot(),rt(0))},dependencies:[z],encapsulation:2,changeDetection:0})}return e})();var ti=`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
